      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white rounded-3xl shadow-xl shadow-slate-200/50 border border-slate-100 overflow-hidden">
            ...
            <div className="flex justify-between items-end mb-4">
              <div>
                ...
                <p className="text-slate-500 text-sm mt-1">
                  Don't worry about formatting. Just dump your brain.
                </p>
              </div>
              <button
                type="button"
          ...
          {showResult && (
            <div
              id="results-section"
              className="bg-slate-50 border-t border-slate-100 p-8 md:p-12 animate-in fade-in slide-in-from-bottom-4 duration-700"
            >
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="bg-white p-6 rounded-2xl shadow-sm border border-slate-200">
                  <h4 className="text-slate-500 font-medium mb-4">
                    Productivity Score
                  </h4>
                  <div className="flex items-end gap-4">
                    <span className="text-6xl font-black text-slate-900">
                      42<span className="text-2xl text-slate-400">/100</span>
                    </span>
                    <span className="px-3 py-1 rounded-full bg-red-100 text-red-700 text-xs font-bold mb-4">
                      CRITICAL
                    </span>
                  </div>
              ...
              <div className="mt-8 p-6 bg-indigo-600 rounded-2xl text-white shadow-lg relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-xl md:text-2xl font-medium leading-relaxed">
                    ...
                    today. At an average rate of $50/hr, you essentially set{" "}
                    <span className="font-bold text-yellow-300">
                      $120 on fire
                    </span>
                    . Try batching your Slack checks to 9AM and 1PM tomorrow."
                  </p>
                </div>
              </div>
              ...
              <div className="mt-8 flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  href="/dashboard"
                  className="flex items-center justify-center gap-2 px-8 py-4 bg-white text-indigo-600 rounded-xl font-bold shadow-lg hover:shadow-xl transition-all hover:-translate-y-0.5 border-2 border-indigo-100"
                >
                  <ChartIcon />
                  View Suggestions
                </Link>
                <button
                  ...
                  className="flex items-center justify-center gap-2 px-8 py-4 bg-slate-100 text-slate-700 rounded-xl font-bold hover:bg-slate-200 transition-all"
                >
                  Analyze Again
                </button>
              </div>
